# Exp-04: Auto Loop Engineering — xgboost_football_exp_04_auto_loop
...
- Se analizaron 111 trials con un score compuesto (accuracy - 0.5·overfit_gap - 0.05·log_loss).
- Se generó una estrategia estabilizada a partir del mejor trial.
- Se reentrenó y guardó el modelo `xgboost_football_exp_04_auto_loop`.
...
| Test accuracy promedio | 59.66% |
| Overfit gap promedio | 11.01% |
| Log loss promedio | 0.8945 |
...
./mondial auto-loop --trials 100 --name xgboost_football_exp_04_auto_loop

# Usar el modelo entrenado
./mondial predecir --home Brazil --away Morocco --model xgboost_football_exp_04_auto_loop
```
