...
namespace MondialXboost.Web.DAL
{
    public class MondialXboostDbContext : DbContext
    {
        public MondialXboostDbContext(DbContextOptions<MondialXboostDbContext> options) : base(options)
        {
        }
