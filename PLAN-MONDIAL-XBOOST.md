...
```
MondialXboost.Web (C# / ASP.NET Core)
...
│  MondialXboost.Web (ASP.NET Core) + Dashboard React/Vite (opcional)     │
...
|------------|-----------|-----|
| MondialXboost.Web | ASP.NET Core 8 | API + Frontend |
...
```
Mondial-Xboost/
├── MondialXboost.Web/                    ← C# (existente, extendido)
│   ├── Predictors/
